...
<script>
export default {
    name: "TheDescendingDrinksFilter",
    ...
    async mounted() {
        //API Bebidas com filtro de preço e em ordem decrescente
        const resp = await fetch("https://tegra-food-skyot.herokuapp.com/products?page=1&order=DESC&filter=bebida&category=bebida&max=15&min=10");
