...
export default {
    ...
    async mounted() {
        //API Bebidas com filtro de preço e ordem crescente
        const resp = await fetch("https://tegra-food-skyot.herokuapp.com/products?page=1&order=ASC&filter=bebida&category=bebida&max=15&min=10");
