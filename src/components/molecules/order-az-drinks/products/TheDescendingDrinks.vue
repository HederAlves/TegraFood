...
export default {
    ...
    async mounted() {
        //API Bebidas em ordem decrescente
        const resp = await fetch("https://tegra-food-skyot.herokuapp.com/products?page=1&order=DESC&filter=bebida&category=bebida");
