...
export default {
    ...
    async mounted() {
        //API Salgados com filtro de preço e ordem crescente
        const resp = await fetch("https://tegra-food-skyot.herokuapp.com/products?page=1&order=ASC&filter=salgado&category=salgado&max=15&min=10");
