...
export default {
    ...
    async mounted() {
        //API Salgados com filtro de preço e em ordem decrescente
        const resp = await fetch("https://tegra-food-skyot.herokuapp.com/products?page=1&order=DESC&filter=salgado&category=salgado&max=15&min=10");
