...
export default {
    ...
    async mounted() {
        //API Salgados em ordem crescente
        const resp = await fetch("https://tegra-food-skyot.herokuapp.com/products?page=1&order=ASC&filter=salgado&category=salgado");
