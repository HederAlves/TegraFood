...
export default {
    ...
    async mounted() {
        //API sobremesas em ordem crescente
        const resp = await fetch("https://tegra-food-skyot.herokuapp.com/products?page=1&order=ASC&filter=sobremesa&category=sobremesa");
