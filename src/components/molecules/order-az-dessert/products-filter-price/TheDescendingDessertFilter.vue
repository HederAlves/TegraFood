...
<script>
export default {
    name: "TheDescendingDessertFilter",
    ...
    async mounted() {
        //API Sobremesas com filtro de preço e em ordem decrescente
        const resp = await fetch("https://tegra-food-skyot.herokuapp.com/products?page=1&order=DESC&filter=sobremesa&category=sobremesa&max=15&min=10");
