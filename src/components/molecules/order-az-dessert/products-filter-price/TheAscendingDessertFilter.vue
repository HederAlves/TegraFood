...
<script>
export default {
    name: "TheAscendingDessertFilter",
    ...
    async mounted() {
        //API Sobremesas com filtro de preço e ordem crescente
        const resp = await fetch("https://tegra-food-skyot.herokuapp.com/products?page=1&order=ASC&filter=sobremesa&category=sobremesa&max=15&min=10");
