...
<script>
export default {
    name: "TheAscendingAllProductsFilter",
    ...
    async mounted() {
        //API Todos os produtos com filtro de preço e ordem crescente
        const resp = await fetch("https://tegra-food-skyot.herokuapp.com/products?page=1&order=ASC&max=15&min=10");
