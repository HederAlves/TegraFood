...
<script>
export default {
    name: "TheDescendingAllProductsFilter",
    ...
    async mounted() {
        //API Todos os produtos com filtro de preço e em ordem decrescente
        const resp = await fetch("https://tegra-food-skyot.herokuapp.com/products?page=1&order=DESC&max=15&min=10");
